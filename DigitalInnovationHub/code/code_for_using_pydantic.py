...
class Type6(Enum):
    DigitalInnovationHub = 'DigitalInnovationHub'


class DigitalInnovationHub(BaseModel):
    ...
    competences: Optional[List[str]] = Field(
        None, description='Competences of the Digital Innovation Hub'
    )
    dataProvider: Optional[str] = Field(
        None,
        description='A sequence of characters identifying the provider of the harmonised data entity',
    ...
    domain: Optional[List[str]] = Field(
        None, description='Domain of the Digital Innovation Hub'
    )
    id: Optional[
        Union[
            constr(
    ...
    logo: Optional[str] = Field(
        None, description='URL of the logo of the Digital Innovation Hub'
    )
    name: Optional[str] = Field(None, description='The name of this item')
    owner: Optional[
        List[
    ...
    representatives: Optional[List[Representative]] = Field(
        None, description='Representatives of the Digital Innovation Hub'
    )
    seeAlso: Optional[Union[List[AnyUrl], AnyUrl]] = Field(
        None, description='list of uri pointing to additional resources about the item'
    )
    socialAccounts: Optional[SocialAccounts] = Field(
        None,
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI entity type. It has to be DigitalInnovationHub'
    )
    website: Optional[str] = Field(
        None, description='Website of the Digital Innovation Hub'
    )
